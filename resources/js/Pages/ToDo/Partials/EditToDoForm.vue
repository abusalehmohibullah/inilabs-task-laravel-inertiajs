...
const editToDo = () => {
    form.post(route('to-dos.update', props.toDo.id), {
        preserveScroll: true,
    })
};
</script>
...
<template>
    <div>
        <FormSection @submitted="editToDo">
            <template #heading>
                Edit Task
            </template>
            <template #form>
                ...
                <TextArea id="description" v-model="form.description" class="block w-full" type="text"
                    name="description" />
            </template>
